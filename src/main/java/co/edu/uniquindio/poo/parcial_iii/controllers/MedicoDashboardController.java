...
public class MedicoDashboardController implements Initializable {
    ...
    @FXML
    private Button btnCitasAsignadas;

    @FXML
    private Button btnHistorialPacientes;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (currentUser instanceof Medico) {
            Medico medico = (Medico) currentUser;
            lblWelcomeMedic.setText("Welcome Dr. " + medico.getNombre() + " " + medico.getApellido() + "!");
        }
    }
    ...
    @FXML
    void goToHistorialPacientes(ActionEvent event) {
        // This could show patient history or appointment history
        goToCitasAsignadas(event);
    }
